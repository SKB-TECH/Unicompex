...
class myPDF extends FPDF {
    ...
    // autres depense
            function headerAutreDepense(){
                ...
                $this->SetFillColor(255, 255, 255);
                $this->Cell(15,7,utf8_decode('N°'),1,0,'C', true);
                $this->Cell(100,7,utf8_decode('Motif'),1,0,'C', true);
                $this->Cell(30,7,utf8_decode('Montant'),1,0,'C', true);
                $this->Ln();
            ...
            function rowsAutresDepenses($db){
                ...
                while($data = $res->fetch()){
                    ...
                    $this->SetFillColor(255, 255, 255);
                    $this->Cell(15,7,utf8_decode($i),1,0,'C', true);
                    $this->Cell(100,7,utf8_decode($data['motif']),1,0,'L', true);
                    $this->Cell(30,7,$data['montant']." ".$data['um'],1,0,'C', true);
                    // $total += $data['motif'];
                    $devise = $data['um'];
                    $this->Ln();
                }
                 $this->Cell(115,7,"TOTAL",1,0,'C', true);
...
$pdf->headerAutreDepense();
$pdf->rowsAutresDepenses($db);
$pdf->Ln(7);
