...
class myPDF extends FPDF {
    ...
    function headerTable(){
        ...
        $this->Cell(15,7,'Fonction',1,0,'C', true);
        $this->Cell(30,7,utf8_decode('Grade'),1,0,'C', true);
        $this->Cell(20,7,utf8_decode('SB'),1,0,'C', true);
        $this->Cell(15,7,utf8_decode('Mitualite'),1,0,'C', true);
        $this->Cell(15,7,utf8_decode('Avance'),1,0,'C', true);
        $this->Cell(15,7,utf8_decode('Net'),1,0,'C', true);
        
    }
    function vieTable($db){
        $i = 0;
        $res=$db->selectalldata2("SELECT  * FROM paie");
        while($data = $res->fetch()){
            ...
            $this->Cell(15,7,$data['grade'],1,0,'L', true);
