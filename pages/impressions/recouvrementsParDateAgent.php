...
class myPDF extends FPDF {
    ...
    function Table($pdo){
       ...
       $date = $_POST['date'];
        $this->Ln(15);
        $this->cell(270,6,utf8_decode('Liste des recouvrement du  '.$date),0,0,'C');
        $this->Ln();
    ...
    function vieTable($pdo){
        ...
        inner join user on user.code_user = recouvrements.idAgent and user.code_user = '$idAg' and recouvrements.dateRec = '$date'
