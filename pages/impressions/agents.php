...
class myPDF extends FPDF {
    ...
    function Table($db){
        ...
        $this->Ln(15);
        $this->cell(270,6,utf8_decode('Liste des agens '),0,0,'C');
        $this->Ln();
    ...
    function headerTable(){
        ...
        $this->Cell(45,7,'Noms',1,0,'C', true);
        
        $this->Cell(30,7,'Adresse',1,0,'C', true);
        $this->Cell(45,7,utf8_decode('Telephone'),1,0,'C', true);
    ...
    function vieTable($db){
        ...
        while($data = $res->fetch()){
            ...
            $this->Cell(15,7,utf8_decode($i),1,0,'C', true);
              $this->Cell(45,7,$data['noms'],1,0,'L', true);
          
            $this->Cell(30,7,$data['adresse'],1,0,'L', true);
            $this->Cell(45,7,$data['telephone'],1,0,'C', true);
            $this->Cell(45,7,$data['sexe'],1,0,'C', true);
